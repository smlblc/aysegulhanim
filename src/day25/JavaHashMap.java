...
//        public Object get(Object key):This method is used to return the value for the specified key.
        ...
        Double sdetSalary = map.get("SDET");   ///BUNA BI BAK!!!
...
//        public Set keySet(): This method is used to return the Set view containing all the keys.
        Set<String> allKeysInMap = map.keySet();// bizim tum keysler sete donus.
         System.out.println(allKeysInMap+"------------");

        for (String keys:map.keySet()) {
            System.out.println(keys+" Value is "+map.get(keys)+"<------------");
        }

//        public Set entrySet(): This method is used to return the Set view containing all the keys and values.
        Set<Map.Entry<String, Double>> entries = map.entrySet();
        for (Map.Entry<String, Double> row : map.entrySet()) { // or row:entries
            ...
            for (Map.Entry<String, Double> row1 : entries) {
                System.out.println("Key: " + row1.getKey() + "   Value: " + row1.getValue());
                if (row1.getValue() > 200_000) {
                    System.out.println("Dream salary!!!");
                }
            }
        // .values() method  returns all values in map
        ArrayList<Double> salaries = new ArrayList<>(map.values());
        ArrayList<String> salaries2 = new ArrayList<>(map.keySet());// ARRAYLISTTE TASIR
        HashSet<Double> sss= new HashSet<>(map.values());
